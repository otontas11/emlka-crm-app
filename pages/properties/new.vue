      ...
      <div class="card-body p-0">
        ...
        <div class="hero-bottom px-4 py-3">
          <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <button type="button" class="btn btn-outline-secondary rounded-pill px-4" @click="goToList">
    ...
    <div class="row g-4">
      ...
      <div class="col-12">
        <div class="d-flex gap-2">
          ...
          <button type="button" class="btn btn-light border rounded-pill px-4" @click="clearForm">
            Temizle
          </button>
        </div>
      </div>
