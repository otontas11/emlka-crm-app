<script setup>
import { createProperty } from '~/composables/useProperties'
...
const saveProperty = () => {
  ...
  window.location.href = '/properties/' + created.id
}
      ...
      <div class="card-body p-0">
        <div class="hero-top p-4 p-lg-5">
          <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div>
              <div class="text-uppercase small text-white-50 mb-2">Yeni Portföy</div>
              <h2 class="fw-bold text-white mb-2">{{ form.title || 'Yeni Portföy Ekle' }}</h2>
            ...
            <div class="text-lg-end">
              <div class="small text-white-50 mb-2">Girilen Fiyat</div>
        ...
        <div class="hero-bottom px-4 py-3">
          <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div class="text-muted">Yeni portföy bilgilerini eksiksiz girerek kayıt oluşturun.</div>
            <UiButton variant="secondary" icon="bi-arrow-left" @click="goToList">Listeye Dön</UiButton>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-12">
        <div class="d-flex gap-2">
          <UiButton variant="primary" icon="bi-check2-circle" @click="saveProperty">Kaydet</UiButton>
          <UiButton variant="secondary" @click="clearForm">Temizle</UiButton>
        </div>
      </div>
    </div>
  </div>
